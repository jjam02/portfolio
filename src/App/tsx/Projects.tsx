...
let projects: Project[] = [
    ...
    },
    {
        ...
        title: "Grocery List",
        description:
            "Created a grocery list web application as an introductory project in React. The app allows users to add and delete items, each with a quantity counter to track how much of each item they need. This project provided hands-on experience with fundamental React concepts, including state management, component creation, and form handling, as users interact with the interface to manage their grocery lists.",
        imgUrl: Grocery,
    ...
    },
    {
        ...
        title: "Amp it up!",
        description:
            "Developed an idle clicker game as an introduction to TypeScript. This project provided practical experience with TypeScript and DOM manipulation, focusing on refactoring code and creating functions with clear, descriptive names and well-defined purposes.",
        imgUrl: Clicker,
...
const Projects = () => {
    ...
    return (
        <>
            ...
            <div
                className="container mt-5 mb-0 d-flex flex-column "
